...
import { discount, robot, battleBot } from '../assets';
    ...
    >
      ...
      >
        ...
        <div className="flex flex-row justify-between items-center w-full mt-5">
          <h1 className="flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100.8px] leading-[75px]">
            ...
            <span className="text-gradient">GROBOTS CLUB</span>{' '}
          </h1>
        </div>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          A team of enthusiastic roboteers turning their passion into reality !
        </p>
      </div>
      ...
      >
        <Image
          src={battleBot}
          alt="billing"
          className="w-full relative z-[5] mt-28"
        />
